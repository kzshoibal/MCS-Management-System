...
{{--                                </div>--}}
{{--                            @endif--}}
{{--                            this part is added to layouts/admin.blade.php file--}}
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group"><br>
                                        ...
                                        <img src="{{$user->profile->profile_image}}"><br><br>
                                    </div>
                                </div>
                            </div>
...
{{--                                            <img src="<?php echo asset("/upload/profileimage/$user->profile->profile_image") ?>">&nbsp; &nbsp;&nbsp; &nbsp;--}}
                                            <input type="hidden" name="profile_image" value="{{ Auth::user()->profile->profile_image }}">
